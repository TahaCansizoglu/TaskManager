            ...
            child: Row(
              ...
              children: [
                Container(
                  width: 6,
                  height: 80,
                  decoration: BoxDecoration(color: _getcolor(task.backgroundColor.toString(), "FF"), borderRadius: BorderRadius.circular(45)),
                ),
                const SizedBox(
                  width: 10,
                ),
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(task.title, style: Theme.of(context).textTheme.subtitle2),
                          Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              const Icon(
                    ...
                    SizedBox(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text(task.note, maxLines: 2, overflow: TextOverflow.ellipsis, style: Theme.of(context).textTheme.bodyText1),
                          Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                ...
                RotatedBox(
                  quarterTurns: 3,
                  child: Text(task.isCompleted == 1 ? "COMPLETED" : task.taskType.toString().toUpperCase(), style: card3TextStyle),
                ),
              ],
            ),
          ),
            ...
            children: <Widget>[
              ...
              Visibility(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    var snap = await FirebaseService.firestore.collectionGroup('todo').where('id', isEqualTo: value.id).get();
              ...
              ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  for (var element in snap.docs) {
                    FirebaseService.firestore.collection('Users').doc(FirebaseService.user!.uid).collection('todo').doc(element.id).delete();
                  }
